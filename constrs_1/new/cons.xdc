...
# LEDs
set_property PACKAGE_PIN U16 [get_ports {bl[0]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {bl[0]}]  
set_property PACKAGE_PIN E19 [get_ports {bl[1]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {bl[1]}]  
set_property PACKAGE_PIN U19 [get_ports {bl[2]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {bl[2]}]  
set_property PACKAGE_PIN V19 [get_ports {bl[3]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {bl[3]}]  
set_property PACKAGE_PIN W18 [get_ports {bl[4]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {bl[4]}]  
set_property PACKAGE_PIN U15 [get_ports {bl[5]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {bl[5]}]  
set_property PACKAGE_PIN U14 [get_ports {bl[6]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {bl[6]}]  
set_property PACKAGE_PIN V14 [get_ports {bl[7]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {bl[7]}]  
set_property PACKAGE_PIN V13 [get_ports {al[0]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {al[0]}]  
set_property PACKAGE_PIN V3 [get_ports {al[1]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {al[1]}]  
set_property PACKAGE_PIN W3 [get_ports {al[2]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {al[2]}]  
set_property PACKAGE_PIN U3 [get_ports {al[3]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {al[3]}]  
set_property PACKAGE_PIN P3 [get_ports {al[4]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {al[4]}]  
set_property PACKAGE_PIN N3 [get_ports {al[5]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {al[5]}]  
set_property PACKAGE_PIN P1 [get_ports {al[6]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {al[6]}]  
set_property PACKAGE_PIN L1 [get_ports {al[7]}]       
 set_property IOSTANDARD LVCMOS33 [get_ports {al[7]}]  
